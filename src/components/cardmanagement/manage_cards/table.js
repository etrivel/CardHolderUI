...
class ManageCardinfotable extends React.Component {
  // state
  constructor(props) {
    super(props);
    this.state = {
  ...
  handledata = (val) => {
    debugger;
    this.context.setData({ ...this.context, cardstatus: val });
    this.props.history.push("/card_status");
  };
...
ManageCardinfotable.contextType = EdittablesContext;
export default withStyles(styles)(withRouter(ManageCardinfotable));
