...
class ChangepinInfotable extends React.Component {
  // state
  constructor(props) {
    super(props);
    this.state = {
  ...
  handledata = (val) => {
    this.context.setData({ ...this.context, changepin: val });
...
ChangepinInfotable.contextType = EdittablesContext;
export default withStyles(styles)(withRouter(ChangepinInfotable));
